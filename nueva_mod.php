...
<div class="bloque-bus">
	<h2>NUEVOS MODELOS:</h2>
    	...
    	<form id="modelo"  action="cargar_modelo.php" method="get"  style="padding:10px;">
            <label>Seleccione la Marca correspondiente a los modelos que va a cargar:</label>
            <br>
            ...
            <br>
            <br>
            <label>Ingrese los modelos separados por comas:</label>
            <br>
