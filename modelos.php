...
<div class="menu">
	<div class="nuevo"><a href="nueva_mod.php">Nuevos Modelos</a> </div>
...
JOIN categorias AS c ON m.id_categoria = c.idcat ORDER BY idmod";
...
if ($totEmp> 0) {
  ...
  echo "<tr style=\"cursor:hand\" onMouseOver=\"this.style.background='#E1E1E1'; this.style.color='blue'\" onMouseOut=\"this.style.background='#FFFFFF'; this.style.color='black'\"  >";
    echo "<td class=\"col\" width=\"100\">". $rowEmp['categoria']. "</td>";
	echo "<td class=\"col\">". $rowEmp['nombre']. "</td>";
      // echo "<td class=\"col\">". $rowEmp['Fecha de Alta'] ."</td>";
    echo "<td class=\"col red-bg\" width=\"100\"><a href='borrar_modelo.php?au_id=" . $rowEmp["idmod"]." '>Borrar</a></td>";
    echo "<td class=\"col orange-bg\"  width=\"100\"><a href='editar_modelo.php?au_id=" . $rowEmp["idmod"]." '>Editar</a></td>";
  echo "</tr>";
