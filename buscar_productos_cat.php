...
JOIN categorias AS c ON p.id_categoria = c.idcat WHERE categoria='$_GET[categoria]' ORDER BY codigo *1 ASC;";
...
if ($totEmp> 0) {
  ...
  echo "<tr style=\"cursor:hand\" onMouseOver=\"this.style.background='#E1E1E1'; this.style.color='blue'\" onMouseOut=\"this.style.background='#FFFFFF'; this.style.color='black'\" >";
    ...
    echo "<td class=\"col\" bgcolor=\"#d8d8d8\">". $rowEmp['categoria'] ."</td>";
    ...
    echo "<td class=\"col red-bg\"><a href='borrar_productos.php?pr_id=". $rowEmp["id"]."&imagen=". $rowEmp["imagen"]."'>Borrar</a></td>";
...
<a href="todos_productos.php?pag=1">Ver Todos</a>
