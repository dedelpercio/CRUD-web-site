...
<div class="bloque-bus">
	<h2>Editar Marca:</h2>
    	...
    	<form action="guardar_categoria.php" method="get" style="padding:10px;">
			
			
  <?php 
	$queEmp = "SELECT * FROM categorias WHERE idcat='$id'";
	...
	?>            
			...
			<input type="text" id="categoria" name="categoria"  value="<?php echo $rowEmp['categoria'] ?>" style="width:100%;"/>
